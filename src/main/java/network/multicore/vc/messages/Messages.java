...
import network.multicore.vc.utils.json.DefaultValue;
...
public class Messages extends JsonConfig {
    ...
    @DefaultValue(s = "CONSOLE")
    public String console;

    @SerializedName("internal_exception")
    @DefaultValue(s = "<dark_red>Internal exception: {message}")
    public String internalException;

    @SerializedName("not_connected")
    @DefaultValue(s = "<red>You must be connected to a server to use this command!")
    public String notConnected;

    @SerializedName("not_player")
    @DefaultValue(s = "<red>You must be a player to use this command!")
    public String notPlayer;

    @SerializedName("player_not_found")
    @DefaultValue(s = "<red>Player not found!")
    public String playerNotFound;


    @SerializedName("hub.already_in_hub")
    @DefaultValue(s = "<red>You are already in the hub!")
    public String alreadyInHub;

    @SerializedName("hub.hub_not_set")
    @DefaultValue(s = "<red>Hub server not set!")
    public String hubNotSet;

    @SerializedName("hub.no_player_to_send_to_hub")
    @DefaultValue(s = "<red>There is no player that can be sent to hub!")
    public String noPlayerToSendToHub;

    @SerializedName("hub.player_already_in_hub")
    @DefaultValue(s = "<red>This player is already in the hub!")
    public String playerAlreadyInHub;

    @SerializedName("hub.players_already_in_hub")
    @DefaultValue(s = "<red>Those players are already in the hub!")
    public String playersAlreadyInHub;

    @SerializedName("hub.hub_partial_success")
    @DefaultValue(s = "<gold>You have sent <yellow>{amount}<gold>/<yellow>{total}<gold> players to hub")
    public String hubPartialSuccess;

    @SerializedName("hub.hub_success_target")
    @DefaultValue(s = "<gold>You have been sent to hub by {player}")
    public String hubSuccessTarget;

    @SerializedName("hub.hub_success_source")
    @DefaultValue(s = "<gold>You have sent {player} to hub")
    public String hubSuccessSource;

    @SerializedName("hub.hub_success_multiple_source")
    @DefaultValue(s = "<gold>You have sent {amount} players to hub")
    public String hubSuccessMultipleSource;

    @SerializedName("hub.hub_failure")
    @DefaultValue(s = "<red>The player cannot be sent to hub!")
    public String hubFailure;

    @SerializedName("hub.hub_failure_multiple")
    @DefaultValue(s = "<red>The players cannot be sent to hub!")
    public String hubFailureMultiple;
    ...
    public static String replace(String str, String[] target, Object[] replacement) {
        for (int i = 0; i < target.length; i++) {
            if (replacement[i] instanceof CommandSource src) {
                if (src instanceof Player player) replacement[i] = player.getUsername();
                else replacement[i] = VelocityCompact.getInstance().messages().console;
            }

            str = str.replace(target[i], replacement[i].toString());
        }
    ...
    public static String replace(String str, String target, Object replacement) {
        return replace(str, new String[]{target}, new Object[]{replacement});
    }
