...
public class BanCommand extends AbstractCommand {
    ...
    public void register() {
        ...
        LiteralArgumentBuilder<CommandSource> node = BrigadierCommand
                ...
                .requires(src -> src.hasPermission(Permission.BAN.get()) && src.hasPermission(Permission.BAN_PERMANENT.get()))
    ...
    private int execute(CommandSource src, String targetName, String serverName, String reason) {
        ...
        ModerationUtils.broadcast(targetName, src, server, null, reason, silent, console, Permission.PUNISHMENT_RECEIVE_BAN, "ban");
