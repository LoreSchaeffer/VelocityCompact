...
public class GBanCommand extends AbstractCommand {
    ...
    public void register() {
        ...
        LiteralArgumentBuilder<CommandSource> gbanRootNode = BrigadierCommand
        ...
        proxy.getCommandManager().register(buildMeta(), new BrigadierCommand(gbanRootNode.build()));
    }
    ...
    private int execute(CommandSource src, String targetName, String reason) {
        ...
        ModerationUtils.broadcast(targetName, src, null, null, reason != null ? reason : messages.get("no-reason"), silent, console, Permission.PUNISHMENT_RECEIVE_BAN, "ban");
